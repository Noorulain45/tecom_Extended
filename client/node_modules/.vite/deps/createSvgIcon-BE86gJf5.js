...
function deepClone(source) {
	if (/* @__PURE__ */ import_react$19.isValidElement(source) || !isPlainObject(source)) return source;
	const output = {};
...
function deepmerge(target, source, options = { clone: true }) {
	...
	if (isPlainObject(target) && isPlainObject(source)) Object.keys(source).forEach((key) => {
		if (/* @__PURE__ */ import_react$19.isValidElement(source[key])) output[key] = source[key];
...
function isMuiElement(element, muiNames) {
	...
	return /* @__PURE__ */ import_react$18.isValidElement(element) && muiNames.indexOf((_muiName = element.type.muiName) != null ? _muiName : (_element$type = element.type) == null || (_element$type = _element$type._payload) == null || (_element$type = _element$type.value) == null ? void 0 : _element$type.muiName) !== -1;
}
var import_react$18;
...
var import_react$17, useEnhancedEffect;
var init_useEnhancedEffect$2 = __esmMin((() => {
	import_react$17 = /* @__PURE__ */ __toESM(require_react());
	useEnhancedEffect = typeof window !== "undefined" ? import_react$17.useLayoutEffect : import_react$17.useEffect;
}));
//#endregion
...
function useGlobalId(idOverride) {
	const [defaultId, setDefaultId] = import_react$16.useState(idOverride);
...
var import_react$16, globalId, maybeReactUseId;
var init_useId$2 = __esmMin((() => {
	import_react$16 = /* @__PURE__ */ __toESM(require_react());
	globalId = 0;
	maybeReactUseId = import_react$16["useId".toString()];
}));
//#endregion
...
function useControlled({ controlled, default: defaultProp, name, state = "value" }) {
	const { current: isControlled } = import_react$15.useRef(controlled !== void 0);
	const [valueState, setValue] = import_react$15.useState(defaultProp);
	const value = isControlled ? controlled : valueState;
	{
		...
		const { current: defaultValue } = import_react$15.useRef(defaultProp);
		import_react$15.useEffect(() => {
	...
	return [value, import_react$15.useCallback((newValue) => {
...
function useEventCallback(fn) {
	const ref = import_react$14.useRef(fn);
	useEnhancedEffect(() => {
		ref.current = fn;
	});
	return import_react$14.useRef((...args) => (0, ref.current)(...args)).current;
}
var import_react$14;
...
function useForkRef(...refs) {
	...
	*/
	return import_react$13.useMemo(() => {
...
function useIsFocusVisible() {
	const ref = import_react$12.useCallback((node) => {
		if (node != null) prepare(node.ownerDocument);
	}, []);
	const isFocusVisibleRef = import_react$12.useRef(false);
	/**
...
var import_react$12, hadKeyboardEvent, hadFocusVisibleRecently, hadFocusVisibleRecentlyTimeout, inputTypesWhitelist;
...
//#endregion
export { require_interopRequireDefault as n, require_createSvgIcon as t };

//# sourceMappingURL=createSvgIcon-BE86gJf5.js.map